...
import com.cn.hnust.cxf.impl.HelloWorldImpl;
 ...
 * 
 */
@WebServiceClient(name = "HelloWorldImplService", targetNamespace = "http://impl.cxf.hnust.cn.com/", wsdlLocation = "http://127.0.0.1:8084/MyXm/webservice/HelloWorld?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOWORLDIMPLSERVICE_QNAME = new QName("http://impl.cxf.hnust.cn.com/", "HelloWorldImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://127.0.0.1:8084/MyXm/webservice/HelloWorld?wsdl");
    ...
    public HelloWorldImpl getHelloWorldImplPort() {
        return super.getPort(new QName("http://impl.cxf.hnust.cn.com/", "HelloWorldImplPort"), HelloWorldImpl.class);
    }
    ...
    public HelloWorldImpl getHelloWorldImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://impl.cxf.hnust.cn.com/", "HelloWorldImplPort"), HelloWorldImpl.class, features);
    }
